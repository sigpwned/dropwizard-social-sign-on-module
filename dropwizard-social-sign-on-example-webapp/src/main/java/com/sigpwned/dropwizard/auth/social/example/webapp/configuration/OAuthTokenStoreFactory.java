 ...
 */
public class OAuthTokenStoreFactory {
  /**
  ...
  @JsonIgnore
  private DefaultOAuthTokenStore instance;

  public DefaultOAuthTokenStore build() {
    if (instance == null)
      instance = new DefaultOAuthTokenStore(getUsername(), getPassword());
    return instance;
  }
}
